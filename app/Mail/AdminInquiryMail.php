...
class AdminInquiryMail extends Mailable
{
    ...
    {   
        ...
        return $this->view('emails.admin-inquiry', ['mail' => $mail,'name'=>$name,'guest'=>$guest,'contact'=>$contact,'messages'=>$message,'trip_id'=>$trip_id,'num_ppl'=>$num_ppl])->subject('Trip Inquiry');
    }
}
