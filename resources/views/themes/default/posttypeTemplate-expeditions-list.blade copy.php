...
<section class="uk-section bg-white uk-position-relative">
  <div class=" uk-section uk-padding-remove-top uk-container">
    <p class="uk-text-justify">{!! $data->content !!}</p>
  ...
  @if($expeditions->count() > 0)
    <div class="uk-container">
          ...
          <div class="uk-grid uk-child-width-1-2@s uk-margin uk-margin-remove-horizontal" uk-scrollspy="target: [uk-scrollspy-class], h1, h3, span, p; cls: uk-animation-slide-top-small; delay: 20; repeat: false;">
              <div class="uk-margin-vertical">
                  <div class="uk_trip uk-transition-toggle uk-link-toggle" uk-scrollspy-class>
                    ...
                    <img src="{{ asset('uploads/original/' . $row->thumbnail)}}" class="uk-image uk-transition-scale-up uk-transition-opaque" alt="" loading="eager">
              ...
              <div class="uk-margin-vertical" style="display:flex; align-items:center;">
                  <div class="uk_trip_content uk-flex uk-flex-center uk-flex-column">
                    <div>
                      ...
                      <h3 class="f-24  uk-margin-top text-secondary-light uk-text-bold" uk-scrollspy-class>{{$row->brief}}</h3>
                      <p>{{$row->content}}</p>
      ...
      <!--  <li>-->
      <!--    <div class="uk_trip uk-transition-toggle uk-link-toggle" uk-scrollspy-class>-->
      <!--      <a href="{{ route('page.destinationlist', $item->uri) }}" class="uk-media-350 uk_trip_image uk-position-relative">-->
      ...
      <!--        <div>-->
      <!--          <div class="uk-h3 uk-text-bold uk-margin-remove text-secondary-light" uk-scrollspy-class></div>-->
      <!--          <div class="f-14 uk-margin-top text-secondary-light" uk-scrollspy-class>{{$item->content}}</div>-->
      <!--        </div>-->
      <!--        <a href="{{ route('page.destinationlist', $item->uri) }}" class="uk-width-1-1 uk-button button-primary button-primary-active uk-margin-top" uk-scrollspy-class>View Details</a>-->
      <!--      </div>-->
      <!--    </div>-->
      <!--  </li>-->
      <!--  @endforeach -->
