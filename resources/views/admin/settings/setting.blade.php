        ...
        <div class="col-md-9">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-2 control-label">Wikipedia Link</label>
                        <div class="col-lg-8">
                            <div class="bs-component">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <textarea class="form-control" id="contentEditor5" name="meta_key" rows="3">{{ $data->meta_key }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <textarea class="form-control" id="contentEditor1" name="google_map2" rows="3">{{ $data->google_map2 }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="xedit-demo">
                            ...
                            @if ($data->banner)
                                <span class="banner{{ $data->id }}">
                                    <a href="{{ $data->id }}" id="banner_remove"><span>X</span></a>
                                    <a href="{{ asset('uploads/original/' . $data->banner) }}" target="_blank"><img
                                            src="{{ asset('uploads/original/' . $data->banner) }}" name="banner"
                                            width="150" /></a>
                                    <hr>
                                </span>
                            @endif
        ...
        (function($) {
            $('#banner_remove').on('click', function(e) {
                ...
                if (confirm('Are you sure to delete??')) {
                    var csrf = $('meta[name="csrf-token"]').attr('content');
                    var id = $(this).attr('href');
                    var url = '{{ route('banner-remove', ['id' => ':id']) }}';
                    // alert(url);
                    url = url.replace(':id', id);
                    $.ajax({
                        type: 'get',
