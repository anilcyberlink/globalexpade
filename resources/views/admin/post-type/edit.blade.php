            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="post_tag" name="post_tag" class="form-control" placeholder=""
                                    value="{{ $data->post_tag }}" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <select name="is_menu" class="form-control input-sm">
                                    <option value="0" {{ $data->is_menu == '0' ? 'selected' : '' }}> Off </option>
                                    <option value="1" {{ $data->is_menu == '1' ? 'selected' : '' }}> On </option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="meta_keyword" name="meta_keyword" class="form-control"
                                    placeholder="" value="{{ $data->meta_keyword }}" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-9">
                            <div class="bs-component">
                                <input type="text" id="meta_description" name="meta_description" class="form-control"
                                    placeholder="" value="{{ $data->meta_description }}" />
                            </div>
                        </div>
                    </div>
