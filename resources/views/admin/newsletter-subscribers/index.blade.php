...
@section('breadcrumb')
    <a href="{{ route('newsletter.subscribers.create') }}" class="btn btn-primary btn-sm">Add Subscriber</a>
    {{-- <a href="{{ route('newsletter.subscribers.create') }}" class="btn btn-primary btn-sm">Send Mail</a> --}}
@endsection
@section('content')
                                ...
                                <tbody>
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->unsubscribed_at ?? 'N/A' }}</td>
                                            <td>
                                                <a href="{{ route('newsletter.subscribers.edit', $value->id) }}">Edit</a> | 
                                                <a href="{{ route('newsletter.subscribe.delete', $value->id) }}" onclick="return confirm('Are you sure you want to delete this subscriber?')">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
