<div class="row">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-lg-12">
                        <div class="bs-component">
                            <textarea id="sub_title" name="sub_title" class="form-control" placeholder="Sub Title">{{ old('sub_title') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-6">
                        <div class="bs-component">
                            ...
                            <input type="number" min="1" name="starting_price" class="form-control"
                                value="{{ old('starting_price') }}" placeholder="$" />
                        </div>
                        <small>Note: Total Price must be numeric value!</small>
                    </div>
                    <div class="col-lg-6">
                        <div class="bs-component">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <small>Note: Duration must be numeric value!</small>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-6">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="inputStandard" class="col-lg-5 control-label">Show In Home ?</label>
            <div class="col-lg-7">
                <div class="bs-component">
