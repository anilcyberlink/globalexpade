                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li class="">
                        @if (Request::segment(2) == 'posttype' ||
                                ...
                                Request::segment(2) == 'terms-and-polices' ||
                                Request::segment(2) == 'festive-celerbations' ||
                                Request::segment(2) == 'local-experiences' ||
                    ...
                    <li class="">
                        @if (Request::segment(2) == 'pagetype' ||
                                ...
                                Request::segment(2) == 'travel-insurane' ||
                                Request::segment(2) == 'embassies-and-consulates' ||
                                Request::segment(2) == 'expedition-permit-fees' ||
                                Request::segment(2) == 'visa-fee' ||
                    ...
                    <li class="">
                        ...
                        <ul class="nav sub-nav">
                            <li
                                class="{{ Request::segment(2) == 'expedition' || Request::segment(2) == 'tour-trip' ? 'active' : '' }}">
                    ...
                    <li class="">
                        @if (Request::segment(2) == 'newsletter-subscribers' ||
                                Request::segment(2) == 'newsletter-email-template' ||
                                Request::segment(2) == 'newsletter-subscribers-list')
                            <a class="accordion-toggle menu-open">
                            @else
                                <a class="accordion-toggle">
                        @endif
                    ...
                    <!--  <li class="">-->
                    <!--   @if (Request::segment(1) == 'newsletter-create' ||
                            Request::segment(1) == 'subscriber-create' ||
                            Request::segment(1) == 'send-newsletter' ||
                            Request::segment(1) == 'subscriber-index' ||
                            Request::segment(1) == 'subscriber-edit' ||
                            Request::segment(1) == 'newsletter-index' ||
                            Request::segment(1) == 'newsletter-edit')
-->
                    <!--    <a class="accordion-toggle menu-open">-->
                <!--    @else-->
                    <!--     <a class="accordion-toggle">-->
...
?>
    ...
    <!--<script src="https://cdn.tiny.cloud/1/g3e9kv831pbj6lpanxhz2q43uw9ut5demo6pmdtv3nycypny/tinymce/5/tinymce.min.js"
