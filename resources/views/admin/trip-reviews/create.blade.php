...
<form class="form-horizontal" role="form" action="{{ route('post-trip-review') }}" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-9">
    ...
    <div class="form-group">
     ...
     <div class="col-lg-8">
      <div class="bs-component">
        <div class="bs-component">
          <textarea class="textarea form-control" id="textArea3" name="brief" rows="9" autocomplete="off"></textarea>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-8">
     <div class="bs-component">
       <div class="bs-component">
         <textarea class="textarea form-control" id="textArea3" name="content" rows="9" autocomplete="off"></textarea>
       </div>
     </div>
   </div>
 </div>
