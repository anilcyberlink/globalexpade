        		...
        		<table class="table admin-form table-striped dataTable" id="datatable3">
        			...
        			<tbody>
        				...
        				@foreach($review as $key=>$row)
        					...
        					<td class="">@if($row->image)<img src="{{asset('uploads/reviews/'.$row->image)}}" width="100px">@endif <br>{{ ucfirst($row->name) }} </td>						
        					
        					<td class="">{!! \Illuminate\Support\Str::limit($row->brief,50,'...') !!}</td>
