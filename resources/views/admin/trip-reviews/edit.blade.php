...
<form class="form-horizontal" role="form" action="{{route('edit-trip-review',$data->id)}}" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-8">
          <div class="bs-component">
            <input type="text" id="category" name="name" class="form-control" placeholder="" value="{{$data->name}}"/>
          </div>
        </div>
      </div>   
  ...
  <div class="form-group">
    ...
    <div class="col-lg-8">
     <div class="bs-component">
       <div class="bs-component">
         <textarea class="textarea form-control" id="textArea3" name="content" rows="9" autocomplete="off">
