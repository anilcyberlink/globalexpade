        ...
        <div class="col-md-8">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">Edit Region </span>
                </div>
                ...
                <div class="sid_bvijay mb10">
                    <div class="hd_show_con">
                        <div class="publice_edi">
                            ...
                            <!--<a href="avoid:javascript;" data-toggle="collapse" data-target="#publish_1">{{ $data->status == '1'?'Active':'Inactive' }}</a>-->
                        </div>
                    </div>
                    <footer>
    ...
    <script type="text/javascript">
        $('.imagedelete').on('click', function(e) {
          ...
          $('.thumbdelete').on('click', function(e) {
            ...
            $.ajax({
                type: 'delete',
                url: "{{ url('delete_region_thumb') . '/' }}" + id,
                data: {
                    _token: csrf
                },
                success: function(data) {
