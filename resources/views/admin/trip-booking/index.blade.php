                                        ...
                                        @foreach ($book as $key => $row)
                                            <tr class="bg-light">
                                                ...
                                                <td class="">
                                                    ...
                                                    {{ $row->country }} <br>
                                                    Find us :
                                                    @if($row->num_people == 'referral')
                                                        Client Referral
                                                    @elseif($row->num_people == 'web')
                                                        Web Search
                                                    @elseif($row->num_people == 'social')
                                                        Social Media
                                                    @else
                                                        N/A
                                                    @endif
                                                </td>
                                                <td class="">Arrival: {{ $row->arrival_date }}
                                                    <br>Departure:{{ $row->departure_date }}</td>
                                                <td class="">
                                                    <textarea readonly>{!! $row->comments !!}</textarea>
                                                </td>
